...
type ProtocolMessage_ClientRequest struct {
	ClientRequest *ClientRequest `protobuf:"bytes,29,opt,name=client_request,json=clientRequest,proto3,oneof"`
}

type ProtocolMessage_ClientResponse struct {
	ClientResponse *ClientResponse `protobuf:"bytes,30,opt,name=client_response,json=clientResponse,proto3,oneof"`
}
...
var file_messenger_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfc, 0x0e, 0x0a,
	...
	0x74, 0x75, 0x66, 0x66, 0x4e, 0x65, 0x77, 0x76, 0x69, 0x65, 0x77, 0x12, 0x41, 0x0a, 0x0e, 0x63,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x1d, 0x20,
	...
	0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x44,
	0x0a, 0x0f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x18, 0x1e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x73, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x48, 0x00, 0x52, 0x0e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x05, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x46, 0x0a, 0x14, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x61,
...
var file_messenger_proto_goTypes = []interface{}{
	...
	(*ClientResponse)(nil),               // 25: protobufs.ClientResponse
...
var file_messenger_proto_depIdxs = []int32{
	...
	24, // 26: protobufs.ProtocolMessage.client_request:type_name -> protobufs.ClientRequest
	25, // 27: protobufs.ProtocolMessage.client_response:type_name -> protobufs.ClientResponse
	...
	24, // 30: protobufs.Messenger.Request:input_type -> protobufs.ClientRequest
	26, // 31: protobufs.Messenger.Buckets:input_type -> protobufs.BucketSubscription
	3,  // 32: protobufs.Messenger.Listen:output_type -> protobufs.BandwidthTestAck
	25, // 33: protobufs.Messenger.Request:output_type -> protobufs.ClientResponse
	27, // 34: protobufs.Messenger.Buckets:output_type -> protobufs.BucketAssignment
